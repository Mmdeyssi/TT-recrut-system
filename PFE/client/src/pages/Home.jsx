    ...
    <div className="bg-stone-100 text-gray-800 flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl text-center lg:text-left text-white">
          ...
          {/* Search bar */}
          <div className="mt-6 w-full max-w-md mx-auto lg:mx-0 rounded-full bg-white shadow-md flex items-center overflow-hidden">
            ...
            <input
              ...
              className="flex-grow px-2 py-3 text-gray-800 focus:outline-none"
            />
            <button
              onClick={searchJobHandler}
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-3 font-semibold transition text-sm sm:text-base"
            >
              Search
            </button>
          </div>
